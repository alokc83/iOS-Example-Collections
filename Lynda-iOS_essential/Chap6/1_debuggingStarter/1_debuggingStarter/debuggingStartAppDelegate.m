...
#import "debuggingStartAppDelegate.h"

#import "debuggingStartViewController.h"

@implementation debuggingStartAppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.viewController = [[[debuggingStartViewController alloc] initWithNibName:@"debuggingStartViewController" bundle:nil] autorelease];
